...
export const productsInitial = [
    ...
    { id: 5, name: "Chupetin", descripcion:"250 gr.", img: "./img/papas.jpg", price: 150, stock: 4 },
    { id: 6, name: "Galletitas", descripcion:"200 gr.", img: "./img/papas.jpg", price: 150, stock: 3 },
    { id: 7, name: "Snickers", descripcion:"100 gr.", img: "./img/papas.jpg", price: 150, stock: 8 },
    { id: 8, name: "Turrón", descripcion:"250 gr.", img: "./img/papas.jpg", price: 150, stock: 8 }
]
